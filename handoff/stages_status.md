...
| Compute compare_iteracoes (deltas + incertezas + xlsx) | `compute_compare_iteracoes` | 🟢 | `runtime/compare_iteracoes/` + `runtime/stages/compute_compare_iteracoes.py` | `nanum_pipeline_29.py::_plot_compare_iteracoes_bl_vs_adtv` (parte dados) | 2026-06-12 — CO medido/específico passam para delta_mode=diff (evita explosão % com Baseline ~0); embeds sheet "compare" em lv_kpis_clean.xlsx |
