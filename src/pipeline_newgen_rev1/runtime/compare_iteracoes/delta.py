...
def build_delta_table(
    ...
    *,
    ...
    if delta_mode == "diff":
        ...
        m["delta_pct"] = m["delta_abs"]
        m["uA_delta_pct"] = (m["uA_right"] ** 2 + m["uA_left"] ** 2) ** 0.5
        m["uB_delta_pct"] = (m["uB_right"] ** 2 + m["uB_left"] ** 2) ** 0.5
        m["uc_delta_pct"] = (m["uc_right"] ** 2 + m["uc_left"] ** 2) ** 0.5
